...
def app():
    ...
    # ---------------- Load Data ----------------
    batsmen = pd.read_csv("CricBuzz-LIVE-SCORES-APP/CSV FILES/Batsmen_stats.csv")
    allrounder_bat = pd.read_csv("CricBuzz-LIVE-SCORES-APP/CSV FILES/All Rounder Batting Stats.csv")
    bowlers = pd.read_csv("CricBuzz-LIVE-SCORES-APP/CSV FILES/Bowlers_stats.csv")
    allrounder_bowl = pd.read_csv("CricBuzz-LIVE-SCORES-APP/CSV FILES/All Rounder Bowling Stats.csv")
