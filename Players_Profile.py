...
def app():
    ...
    def load_all_data():
        datasets = {}
        datasets['batsmen'] = read_csv_robust('CricBuzz-LIVE-SCORES-APP/CSV FILES/Batsmen_stats.csv')
        datasets['bowlers'] = read_csv_robust('CricBuzz-LIVE-SCORES-APP/CSV FILES/Bowlers_stats.csv')
        datasets['allrounder_bat'] = read_csv_robust('CricBuzz-LIVE-SCORES-APP/CSV FILES/All Rounder Batting Stats.csv')
        datasets['allrounder_bowl'] = read_csv_robust('CricBuzz-LIVE-SCORES-APP/CSV FILES/All Rounder Bowling Stats.csv')
        datasets['players'] = read_csv_robust('CricBuzz-LIVE-SCORES-APP/CSV FILES/Players_Data.csv')
        return datasets
